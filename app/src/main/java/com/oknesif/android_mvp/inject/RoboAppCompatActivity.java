...
/**
 * Created by dvaletin on 11.10.15.
 * Copyright (c) 2015 WordLines2.0. All rights reserved.
 */
public class RoboAppCompatActivity extends AppCompatActivity implements RoboContext {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopwatch.resetAndLog("RoboAppcompatActivity creation of injector");
        eventManager = injector.getInstance(EventManager.class);
        stopwatch.resetAndLog("RoboAppcompatActivity creation of eventmanager");
        injector.injectMembersWithoutViews(this);
        stopwatch.resetAndLog("RoboAppcompatActivity inject members without views");
        super.onCreate(savedInstanceState);
        stopwatch.resetAndLog("RoboAppcompatActivity super onCreate");
        eventManager.fire(new OnCreateEvent<Activity>(this, savedInstanceState));
        stopwatch.resetAndLog("RoboAppcompatActivity fire event");
    }
